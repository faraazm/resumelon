...
const plans = [
  ...
  },
  {
    ...
    price: "$19.99",
    period: "/month",
    description: "Unlimited AI-powered tailoring, optimization, and exports",
    features: [
      "Unlimited resumes & cover letters",
      "All templates",
      "PDF & DOCX downloads",
      "500 AI generations per month",
      "2,000 AI optimizations",
  ...
  },
  {
    ...
    price: "$99.99",
    period: "/year",
    description: "Best value — save 58% with everything in Pro",
    features: [
