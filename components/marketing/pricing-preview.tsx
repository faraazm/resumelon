...
const plans = [
  {
    name: "Free",
    price: "$0",
    description: "Create resumes and cover letters with all templates — AI features are limited",
    features: [
      ...
      { text: "10 AI optimizations total", included: true },
  ...
  },
  {
    ...
    description: "Unlimited AI-powered tailoring, optimization, and exports for every application",
    features: [
      { text: "Unlimited resumes & cover letters", included: true },
      { text: "All templates", included: true },
      { text: "ATS-optimized format", included: true },
      ...
      { text: "2,000 AI optimizations", included: true },
      { text: "AI resume scoring & feedback", included: true },
