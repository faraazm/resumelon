    ...
    <div className="flex-1 overflow-hidden">
      <ScrollArea className="h-full">
        <div className="max-w-3xl p-4 md:p-6 space-y-8">
          {/* Templates */}
          <DesignSection title="Template" description="Choose an ATS-optimized template">
          ...
          {/* Layout Options */}
          <DesignSection title="Layout Options" description="Customize layout elements">
          ...
          {/* Spacing */}
          <DesignSection title="Spacing" description="Adjust the density of your resume">
            <SpacingSelector
          ...
          {/* Background Color */}
          <DesignSection title="Background Color" description="Choose a background color for your resume">
            <ColorPicker
          ...
          {/* Accent Color */}
          <DesignSection title="Accent Color" description="Choose a color for section headings and dividers">
            <ColorPicker
              colors={accentColors}
